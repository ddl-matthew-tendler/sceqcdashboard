...
var MOCK_PROJECT_TAGS = {
  ...
  // Additional projects for AI Insights benchmark comparison
  'proj-cardio-ph3': [
    { key: 'Therapeutic-Area', value: 'Cardiology / Heart-Failure' },
    { key: 'Clinical-Phase', value: 'Phase-3' },
    { key: 'Drug-Compound', value: 'Compound-208' },
    { key: 'Team', value: 'Cardio-Programming' },
    { key: 'Project-Status', value: 'Complete' },
  ],
  'proj-safety-ph1': [
    { key: 'Therapeutic-Area', value: 'Oncology / Solid-Tumors' },
    { key: 'Clinical-Phase', value: 'Phase-1' },
    { key: 'Drug-Compound', value: 'Compound-044' },
    { key: 'Team', value: 'Early-Phase-Programming' },
    { key: 'Project-Status', value: 'Complete' },
  ],
  'proj-gene-ph2': [
    { key: 'Therapeutic-Area', value: 'Rare-Disease / Gene-Therapy' },
    { key: 'Clinical-Phase', value: 'Phase-2' },
    { key: 'Drug-Compound', value: 'GT-Vector-12' },
    { key: 'Team', value: 'Gene-Therapy-Programming' },
    { key: 'Project-Status', value: 'Complete' },
  ],
};
...
var MOCK_BUNDLES = [
  ...
  // ── CS3_Cardiology (Phase 3 — slow TFL outlier for AI Insights benchmark) ─────
  // Three completed TFLs averaging ~45 days (will be flagged as 2.4x above benchmark)
  {
    id: 'cs3-tfl-001', name: 'T14.1.1 Primary Endpoint by Visit', state: 'Complete',
    projectId: 'proj-cardio-ph3', projectName: 'CS3_Cardiology',
    projectOwner: 'ross_domino',
    policyId: MOCK_POLICIES[2].id, policyName: MOCK_POLICIES[2].name,
    stage: 'Study Lead Verification',
    stages: makeStages(MOCK_POLICIES[2].stages, [MOCK_USERS.prodProg, MOCK_USERS.qcProg, MOCK_USERS.studyLead]),
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 7,
    createdAt: '2025-11-01T09:00:00Z', updatedAt: '2025-12-16T16:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.prodProg),
  },
  {
    id: 'cs3-tfl-002', name: 'T14.1.2 Key Secondary Endpoints Summary', state: 'Complete',
    projectId: 'proj-cardio-ph3', projectName: 'CS3_Cardiology',
    projectOwner: 'ross_domino',
    policyId: MOCK_POLICIES[2].id, policyName: MOCK_POLICIES[2].name,
    stage: 'Study Lead Verification',
    ...
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 9,
    createdAt: '2025-11-10T09:00:00Z', updatedAt: '2025-12-28T14:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.prodProg),
  },
  {
    id: 'cs3-tfl-003', name: 'F14.2.1 Kaplan-Meier Overall Survival', state: 'Complete',
    projectId: 'proj-cardio-ph3', projectName: 'CS3_Cardiology',
    projectOwner: 'ross_domino',
    policyId: MOCK_POLICIES[2].id, policyName: MOCK_POLICIES[2].name,
    stage: 'Study Lead Verification',
    ...
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 6,
    createdAt: '2025-11-20T09:00:00Z', updatedAt: '2026-01-03T11:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.etan),
  },

  // ── Phase1_SafetyStudy (fast TFL reference — ~13 days avg) ─────────────────────
  {
    id: 'ph1-tfl-001', name: 'T14.1 Safety Summary Table', state: 'Complete',
    projectId: 'proj-safety-ph1', projectName: 'Phase1_SafetyStudy',
    projectOwner: 'agnes_domino',
    policyId: MOCK_POLICIES[3].id, policyName: MOCK_POLICIES[3].name,
    stage: 'Study Lead Verification',
    stages: makeStages(MOCK_POLICIES[3].stages, [MOCK_USERS.prodProg, MOCK_USERS.studyLead]),
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 1,
    createdAt: '2025-12-01T09:00:00Z', updatedAt: '2025-12-13T15:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.prodProg),
  },
  {
    id: 'ph1-tfl-002', name: 'T14.2 Dose Escalation Findings', state: 'Complete',
    projectId: 'proj-safety-ph1', projectName: 'Phase1_SafetyStudy',
    projectOwner: 'agnes_domino',
    policyId: MOCK_POLICIES[3].id, policyName: MOCK_POLICIES[3].name,
    stage: 'Study Lead Verification',
    ...
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 0,
    createdAt: '2025-12-10T09:00:00Z', updatedAt: '2025-12-25T11:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.prodProg),
  },

  // ── GeneTherapy_Phase2 (fast TFL reference — ~16 days avg) ────────────────────
  {
    id: 'gt2-tfl-001', name: 'T14.3 Primary Efficacy Responder Table', state: 'Complete',
    projectId: 'proj-gene-ph2', projectName: 'GeneTherapy_Phase2',
    projectOwner: 'agnes_domino',
    policyId: MOCK_POLICIES[2].id, policyName: MOCK_POLICIES[2].name,
    stage: 'Study Lead Verification',
    stages: makeStages(MOCK_POLICIES[2].stages, [MOCK_USERS.prodProg, MOCK_USERS.qcProg, MOCK_USERS.studyLead]),
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 2,
    createdAt: '2025-11-15T09:00:00Z', updatedAt: '2025-11-29T16:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.prodProg),
  },
  {
    id: 'gt2-tfl-002', name: 'F14.1 Tumor Response Forest Plot', state: 'Complete',
    projectId: 'proj-gene-ph2', projectName: 'GeneTherapy_Phase2',
    projectOwner: 'agnes_domino',
    policyId: MOCK_POLICIES[3].id, policyName: MOCK_POLICIES[3].name,
    stage: 'Study Lead Verification',
    ...
    stageAssignee: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
    commentsCount: 1,
    createdAt: '2025-11-20T09:00:00Z', updatedAt: '2025-12-08T10:00:00Z',
    createdBy: makeCreatedBy(MOCK_USERS.prodProg),
  },
];
...
var MOCK_FINDINGS = {
  ...
  // CS3_Cardiology TFL findings — multiple resolved S0/S1 findings explain the long cycle
  'cs3-tfl-001': [
    {
      id: 'f-cs3-001a', name: 'Primary endpoint responder definition mismatch vs SAP',
      bundleId: 'cs3-tfl-001', severity: 'S0', status: 'Done',
      description: 'LVEF threshold used in responder definition did not match SAP v3.1 final specification; required protocol deviation review',
      assignee: { id: MOCK_USERS.prodProg.id, name: 'production_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-11-25T00:00:00Z',
      createdAt: '2025-11-10T09:00:00Z', updatedAt: '2025-12-05T15:00:00Z',
    },
    {
      id: 'f-cs3-001b', name: 'Missing stratification factor in subgroup analysis',
      bundleId: 'cs3-tfl-001', severity: 'S1', status: 'Done',
      description: 'Regional stratification factor omitted from Table 14.1.1 footnote and subgroup rows',
      assignee: { id: MOCK_USERS.qcProg.id, name: 'qc_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-01T00:00:00Z',
      createdAt: '2025-11-18T14:00:00Z', updatedAt: '2025-12-10T11:00:00Z',
    },
    {
      id: 'f-cs3-001c', name: 'Confidence interval rounding inconsistency',
      bundleId: 'cs3-tfl-001', severity: 'S2', status: 'Done',
      description: '95% CI displayed to 1 decimal; SAP specifies 2 decimal places throughout',
      assignee: { id: MOCK_USERS.prodProg.id, name: 'production_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-10T00:00:00Z',
      createdAt: '2025-11-28T10:00:00Z', updatedAt: '2025-12-14T09:00:00Z',
    },
  ],
  'cs3-tfl-002': [
    {
      id: 'f-cs3-002a', name: 'Key secondary p-value hierarchy logic error',
      bundleId: 'cs3-tfl-002', severity: 'S0', status: 'Done',
      description: 'Hierarchical testing order for secondary endpoints did not match pre-specified order in SAP; table footnote also incorrect',
      assignee: { id: MOCK_USERS.prodProg.id, name: 'production_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-11-30T00:00:00Z',
      createdAt: '2025-11-15T09:00:00Z', updatedAt: '2025-12-12T16:00:00Z',
    },
    {
      id: 'f-cs3-002b', name: 'Biomarker subgroup row suppressed incorrectly',
      bundleId: 'cs3-tfl-002', severity: 'S1', status: 'Done',
      description: 'Subgroup with n<5 was suppressed per de-identification rule but rule should not apply to aggregate summaries',
      assignee: { id: MOCK_USERS.qcProg.id, name: 'qc_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-05T00:00:00Z',
      createdAt: '2025-11-25T11:00:00Z', updatedAt: '2025-12-20T10:00:00Z',
    },
    {
      id: 'f-cs3-002c', name: 'Treatment arm label uses internal code not SAP label',
      bundleId: 'cs3-tfl-002', severity: 'S2', status: 'Done',
      description: 'Column header shows "TRT01P" instead of "Treatment Arm (ITT)" as specified in the display mockup',
      assignee: { id: MOCK_USERS.prodProg.id, name: 'production_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-15T00:00:00Z',
      createdAt: '2025-12-01T09:00:00Z', updatedAt: '2025-12-24T11:00:00Z',
    },
    {
      id: 'f-cs3-002d', name: 'Footnote reference numbering out of order',
      bundleId: 'cs3-tfl-002', severity: 'S3', status: 'Done',
      description: 'Footnote (c) appears before (b) in the rendered output due to sort order of the footnote macro',
      assignee: { id: MOCK_USERS.prodProg.id, name: 'production_programmer' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-20T00:00:00Z',
      createdAt: '2025-12-05T14:00:00Z', updatedAt: '2025-12-26T09:00:00Z',
    },
  ],
  'cs3-tfl-003': [
    {
      id: 'f-cs3-003a', name: 'KM curve censoring tick marks missing',
      bundleId: 'cs3-tfl-003', severity: 'S1', status: 'Done',
      description: 'Kaplan-Meier figure missing censored patient tick marks on the survival curve; required by CSR figure standards',
      assignee: { id: MOCK_USERS.etan.id, name: 'etan_domino' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-10T00:00:00Z',
      createdAt: '2025-11-28T10:00:00Z', updatedAt: '2025-12-18T14:00:00Z',
    },
    {
      id: 'f-cs3-003b', name: 'Number at risk table row alignment off by one visit',
      bundleId: 'cs3-tfl-003', severity: 'S1', status: 'Done',
      description: 'Number at risk table underneath the KM figure shows values for wrong time points due to a visit window mismatch',
      assignee: { id: MOCK_USERS.etan.id, name: 'etan_domino' },
      approver: { id: MOCK_USERS.studyLead.id, name: 'study_lead' },
      dueDate: '2025-12-20T00:00:00Z',
      createdAt: '2025-12-05T09:00:00Z', updatedAt: '2025-12-28T11:00:00Z',
    },
  ],
};
